        ...
        <table align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0" width="100%" style="max-width:37.5em;border:1px solid #eaeaea;border-radius:5px;margin:40px auto;padding:20px;width:465px">
          <tr style="width:100%">
            <td>
              ...
              <p style="font-size:14px;line-height:24px;margin:16px 0;color:#000">Hello zenorocha,</p>
                    ...
                    <td>
                      <table align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0" width="100%">
                        <tbody style="width:100%">
                          <tr style="width:100%">
                            <td align="right"><img src="https://react-email-demo-92trk6dwg-resend.vercel.app/static/vercel-user.png" width="64" height="64" style="display:block;outline:none;border:none;text-decoration:none;border-radius:100%" /></td>
              ...
              <p style="font-size:14px;line-height:24px;margin:16px 0;color:#000">or copy and paste this URL into your browser: <a target="_blank" style="color:#067df7;text-decoration:none" href="https://vercel.com/teams/invite/foo" rel="noreferrer">https://vercel.com/teams/invite/foo</a></p>
